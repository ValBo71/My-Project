...
public class A_RegistrationTests extends BaseTest {
    ...
    @Test
    public void TC_R_01_01_UserAccountSuccessfullyCreated_When_ValidValuesAreProvided() {
    ...
    @Test
    public void TC_R_01_02_SecondUserAccountSuccessfullyCreated_When_ValidValuesAreProvided() {
    ...
    @Test
    public void TC_R_01_03_UserAccountSuccessfullyCreatedAsAdmin_When_RequiredFieldsFilledWithValidData() {
